...
**Commits:** 26 auf `main` gepusht (02b31ad → dfbfe5e)
...
25. **Context-Tip-Banner nach Audit-Phase** (`6c86555`) — blauer Hinweis-Banner direkt unter dem Header zeigt pro Status (planned/preparation/fieldwork/reporting/review) den logisch nächsten Schritt nach ISO 19011 § 6. Hilft neuen Auditor:innen ohne Handbuch durch den Lifecycle.
26. **Banner i18n DE + EN** (`dfbfe5e`) — Tips sind jetzt in `auditMgmt.tips`-Namespace in beiden Sprachen.
