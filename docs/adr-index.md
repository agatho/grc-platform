...
| 028 | [`@tanstack/react-table` und der React Compiler](./ADR-028-tanstack-table-und-react-compiler.md) — `incompatible-library` bleibt an, Ausnahme namentlich für zwei Dateien | Accepted | 2026-09-09                   | vorhanden                                        |
