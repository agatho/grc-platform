...
Die Hash-*Formel* ist über die Spalte `hash_version` versioniert. Vier
...
verwendete `created_at::text`, das in der *Session*-Zeitzone serialisiert.
...
Ein Rehash berechnet Hashes aus dem *aktuellen* Zeileninhalt. Das hat drei
...
2. **Er entwertet jeden bereits erteilten externen Zeitstempel.** Die
   verankerten Merkle-Wurzeln sind über die *alten* `entry_hash`-Werte
...
```json
{
  "data": {
    "currentVersion": 4,
    "versionDistribution": { "v0_broken": 0, "v1": 0, "v2": 0, "v3": 15425, "v4": 812 },
    "chainVerification": {
      "healthy": true,
      "rowMismatches": 0,
      "chainMismatches": 0,
    ...
    "freeTsaAnchors": { "lastV2Anchor": "2026-08-31T00:05:11Z", "firstV3Anchor": "2026-09-02T00:05:09Z" },
