...
risk*scenario (+likelihood, impact, risk_score, treatment_strategy, residual*_, status, synced*to_erm, erm_risk_id)
...
ai_system (+eu_database*_, documentation_retention_years, documentation_expiry_date, last_documentation_review)
