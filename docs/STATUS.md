...
- **Offen**: Kein PDF/A (bekannte pdfkit-Lücke, s. `pdf-output-contract.test.ts`); `packages/reporting`s Puppeteer-Renderer weiterhin Alt-Pfad der Template-Engine — Umstellung auf den neuen Kern wäre der nächste Schritt.
