...
CI-Gate, das das bemerkt hätte (→ OP-074, OP-075). *(Der Report wurde nach der Messung wieder
auf den eingecheckten Stand zurückgesetzt — diese Datei ist die einzige Änderung dieser Arbeit.)*
