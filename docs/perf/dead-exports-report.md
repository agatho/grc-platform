...
_Generated: 2026-09-09T07:29:55.272Z_
...
**2468 potenziell tote Exports** in 459 Dateien.
...
| `packages/shared/src/types/eam-advanced.ts`              | 28     | `TransferMechanism`, `EncryptionType`, `EncryptionAtRest`, `DataFlowFrequency`, `DataFlowStatus`, `LegalBasis`, `SchremsIiSafeguard`, `InterfaceType`, `InterfaceDirection`, `HealthStatus` ...                                                                                                                                         |
...
| `packages/shared/src/schemas/audit-advanced.ts`          | 18     | `createWpFolderSchema`, `updateWpFolderSchema`, `updateWorkingPaperSchema`, `WP_STATUS_TRANSITIONS`, `wpTransitionSchema`, `createReviewNoteSchema`, `resolveReviewNoteSchema`, `createReviewNoteReplySchema`, `updateAuditorProfileSchema`, `createResourceAllocationSchema` ...                                                       |
...
| `apps/web/src/lib/documents/signature-provider.ts`       | 13     | `SignatureRequestRow`, `SignatureRow`, `SignatureWorkflowErrorCode`, `SignatureWorkflowError`, `CreateSignatureRequestInput`, `SignatureActionInput`, `DeclineInput`, `SignResult`, `SignatureVerificationLink`, `FileIntegrityState` ...                                                                                               |
...
- `apps/web/src/__tests__/api/helpers/db-proxy.ts` -- `dbMockFactory`
...
- `apps/worker/src/crons/process-mining-conformance.ts` -- `ObservedTransition`, `TraceAnalysis`
...
- `apps/worker/src/lib/notify.ts` -- `DedupeWindow`, `NotifyOptions`, `insertNotifications`
...
- `apps/worker/src/lib/scheduler.ts` -- `ParsedSchedule`, `RunStatus`, `SchedulerHandle`
- `packages/auth/src/anonymous-token.ts` -- `ResolvedInvitation`, `ResolvedScimToken`
- `packages/auth/src/cache/module-config-cache.ts` -- `get`, `invalidate`, `invalidateOrg`, `clearAll`
- `packages/auth/src/index.ts` -- `isPublicExactOrUnder`, `containsPersonalData`, `BULK_EXPORT_MAX_ROWS`, `PERSONAL_DATA_ENTITY_TYPES`
- `packages/auth/src/middleware/bulk-export-guard.ts` -- `PERSONAL_DATA_ENTITY_TYPES`, `BULK_EXPORT_MAX_ROWS`, `BulkExportRequest`, `BulkExportDecision`, `containsPersonalData`
- `packages/auth/src/oidc/id-token-validator.ts` -- `IdTokenClaims`, `IdTokenValidationOptions`, `ALLOWED_ID_TOKEN_ALGORITHMS`
- `packages/auth/src/oidc/index.ts` -- `ALLOWED_ID_TOKEN_ALGORITHMS`
- `packages/auth/src/oidc/token-exchange.ts` -- `TokenExchangeParams`
- `packages/auth/src/providers.ts` -- `LoginLockState`, `LoginUserRow`
- `packages/auth/src/rbac.ts` -- `HINSCHG_ISOLATED_ROLES`, `isPublicExactOrUnder`
- `packages/auth/src/saml/index.ts` -- `rejectXXE`, `IDP_CERT_EXPIRY_WARNING_DAYS`
- `packages/auth/src/saml/request-builder.ts` -- `AuthnRequestOptions`
- `packages/auth/src/saml/response-validator.ts` -- `rejectXXE`, `IDP_CERT_EXPIRY_WARNING_DAYS`, `IdpCertificateInfo`, `SamlSignatureScope`, `VerifiedSamlResponse`
- `packages/auth/src/scim/filter-parser.ts` -- `ScimFilter`
- `packages/auth/src/scim/index.ts` -- `tokenHashesEqual`
...
- `packages/db/src/migrate-all.ts` -- `MigrationMode`, `checksum`
...
- `packages/db/src/rls-audit.ts` -- `RlsScope`, `RlsStatus`, `RlsTableStatus`, `RlsAuditReport`
...
- `packages/db/src/schema/stakeholder-register.ts` -- `stakeholderTypeEnum`, `stakeholderInfluenceEnum`, `stakeholderInterestEnum`, `stakeholderEngagementStrategyEnum`, `stakeholder`, `stakeholderExpectation`, `Stakeholder`, `StakeholderInsert`, `StakeholderExpectation`, `StakeholderExpectationInsert`
...
- `packages/db/src/sql-result.ts` -- `SqlExecuteResult`
- `packages/events/src/index.ts` -- `formatSlackPayload`, `formatTeamsPayload`, `enqueueWebhookDelivery`
- `packages/events/src/webhook-enqueue.ts` -- `enqueueWebhookDelivery`, `__resetWebhookEnqueueRegistration`
- `packages/events/src/webhook-formatter.ts` -- `formatSlackPayload`, `formatTeamsPayload`
- `packages/shared/src/bpmn-validator.ts` -- `ValidationRuleLevel`, `BpmnValidationConfig`
- `packages/shared/src/cache/dashboard-cache.ts` -- `CacheMetrics`
- `packages/shared/src/cascades/bia-asset-criticality.ts` -- `BiaImpactInput`, `ProcessAssetLink`, `DerivedAssetClassification`
- `packages/shared/src/color-utils.ts` -- `HslColor`
- `packages/shared/src/cpe-matcher.ts` -- `ParsedCpe`
- `packages/shared/src/document-control.ts` -- `DocumentVersionNumbers`, `EffectiveDatedVersion`, `FourEyesCheckInput`, `FourEyesCheckResult`, `DOCUMENT_REVIEW_REMINDER_STAGES`, `SIGNATURE_DUE_REMINDER_STAGES`, `SIGNATURE_ESCALATION_GRACE_MS`, `RetentionBasis`, `RetentionPurgeCandidate`
- `packages/shared/src/env-key.ts` -- `AesGcmCiphertext`
- `packages/shared/src/esg-calculations.ts` -- `MaterialityTopicResult`, `TargetProgressResult`
- `packages/shared/src/fair-simulation.ts` -- `FAIRResult`, `DistributionBucket`
- `packages/shared/src/index.ts` -- `webhookUrlRefine`, `webhookUrlRefineMessage`, `RISK_TRANSITIONS_REQUIRING_REASON`
- `packages/shared/src/lib/asn1-der.ts` -- `encodeNull`
...
- `packages/shared/src/lib/clamav.ts` -- `ClamScanStatus`, `ClamScanOptions`
...
- `packages/shared/src/lib/file-signature.ts` -- `MagicSignature`, `SniffedFileType`, `UploadSignatureResult`, `VerifyUploadOptions`
- `packages/shared/src/lib/file-storage.ts` -- `FileStorageMeta`, `S3StorageConfig`, `defaultUploadDir`
- `packages/shared/src/lib/framework-test-plans.ts` -- `TestPlanStep`, `TestPlanTemplate`, `getTestPlanTemplate`
- `packages/shared/src/lib/freetsa.ts` -- `TimestampRequestResult`, `FreeTsaOptions`
- `packages/shared/src/lib/merkle-tree.ts` -- `MerkleProof`
...
- `packages/shared/src/lib/sigv4.ts` -- `encodeCanonicalPath`, `SigV4Input`, `SigV4Result`
- `packages/shared/src/lib/url-safety-server.ts` -- `SafeFetchOptions`, `SsrfBlockedError`
- `packages/shared/src/lib/zip-safety.ts` -- `ZipEntryInfo`, `ZipInspection`, `ZipLimits`
- `packages/shared/src/logger.ts` -- `LogLevel`, `LogFields`, `Logger`, `__scrubForTest`
- `packages/shared/src/maturity/cmmi.ts` -- `MaturitySource`, `Confidence`, `MaturityResult`
- `packages/shared/src/modules.ts` -- `ModuleDefinition`
- `packages/shared/src/nis2-compliance.ts` -- `NIS2OverallScore`, `CertReadinessResult`
- `packages/shared/src/process-approval.ts` -- `ApprovalStepType`, `ApprovalStepStatus`, `ApprovalDecision`, `ApprovalSoDContext`, `approvalConflictActors`, `violatesApprovalSeparationOfDuties`, `ApprovalChainOutcome`
...
- `packages/shared/src/schemas/audit-advanced.ts` -- `createWpFolderSchema`, `updateWpFolderSchema`, `updateWorkingPaperSchema`, `WP_STATUS_TRANSITIONS`, `wpTransitionSchema`, `createReviewNoteSchema`, `resolveReviewNoteSchema`, `createReviewNoteReplySchema`, `updateAuditorProfileSchema`, `createResourceAllocationSchema`, `updateResourceAllocationSchema`, `createAuditTimeEntrySchema`, `updateContinuousAuditRuleSchema`, `acknowledgeExceptionSchema`, `falsePositiveExceptionSchema`, `updateQaChecklistSchema`, `createExternalShareSchema`, `CustomSqlValidation`
...
- `packages/shared/src/schemas/bcms.ts` -- `activateCrisisSchema`
...
- `packages/shared/src/schemas/compliance-culture.ts` -- `cciFactorKeySchema`
...
- `packages/shared/src/schemas/dpms.ts` -- `createRopaDataCategorySchema`, `createRopaDataSubjectSchema`, `createRopaRecipientSchema`, `thirdCountryTransferSchema`
...
- `packages/shared/src/schemas/identity.ts` -- `samlAttributeMappingSchema`, `oidcClaimMappingSchema`, `scimSyncLogFilterSchema`, `toggleSsoEnforcementSchema`
...
- `packages/shared/src/schemas/nis2-certification.ts` -- `NIS2ReportType`, `NIS2ReportStatus`, `CertReadinessCheckDef`
...
- `packages/shared/src/schemas/platform.ts` -- `contactRoleTypes`
...
- `packages/shared/src/schemas/process.ts` -- `approvalStepTypeValues`, `commentListQuerySchema`, `laneCarrierKinds`, `sodSeverityValues`, `biaCriticalityValues`
...
- `packages/shared/src/state-machines/aiact-qms.ts` -- `QmsReadinessResult`, `Iso42001GapResult`, `AiRiskDimension`, `AiRiskAssessmentQuality`
- `packages/shared/src/state-machines/aiact-system.ts` -- `AiRiskCategory`, `Blocker`
- `packages/shared/src/state-machines/bcms-bcp.ts` -- `Blocker`, `BcpTransitionRequest`, `BcpTransitionResult`
- `packages/shared/src/state-machines/bcms-bia.ts` -- `Blocker`, `BiaTransitionRequest`, `BiaTransitionResult`
- `packages/shared/src/state-machines/bcms-crisis.ts` -- `Blocker`, `CrisisTransitionRequest`, `CrisisTransitionResult`, `DoraDeadlines`
...
- `packages/shared/src/state-machines/cross-risk-sync.ts` -- `DpiaSeverity`, `DpiaLikelihood`, `DpiaImpact`, `FundamentalRightImpact`, `SyncDecision`, `SyncBatchInput`, `SyncBatchResult`
- `packages/shared/src/state-machines/dpms-avv.ts` -- `AvvAgreementStatus`, `Blocker`, `AvvTransitionRequest`, `AvvTransitionResult`, `AvvReviewStatus`
- `packages/shared/src/state-machines/dpms-breach.ts` -- `Blocker`, `BreachDeadline`, `BreachTransitionRequest`, `BreachTransitionResult`
- `packages/shared/src/state-machines/dpms-dpia.ts` -- `Blocker`, `DpiaTransitionRequest`, `DpiaTransitionResult`
- `packages/shared/src/state-machines/dpms-dsr.ts` -- `Blocker`, `DsrDeadline`, `DsrTransitionRequest`, `DsrTransitionResult`
- `packages/shared/src/state-machines/dpms-retention.ts` -- `RetentionExecutionContext`, `RetentionDecision`, `ConsentValidationResult`
- `packages/shared/src/state-machines/dpms-ropa.ts` -- `Blocker`, `RopaTransitionRequest`, `RopaTransitionResult`
- `packages/shared/src/state-machines/dpms-tia.ts` -- `Blocker`, `LegalMechanism`, `TransferRiskAssessment`
- `packages/shared/src/state-machines/grc-executive-dashboard.ts` -- `HealthStatus`, `ModuleHealth`, `ExecutiveDashboardResult`
- `packages/shared/src/state-machines/isms-assessment.ts` -- `AssessmentPhase`, `Blocker`, `TransitionRequest`, `TransitionResult`, `PhaseChecklist`
- `packages/shared/src/state-machines/isms-nc.ts` -- `NcTransitionInput`, `NcTransitionResult`, `CaStatus`, `CloseAssertion`
- `packages/shared/src/state-machines/programme-journey.ts` -- `JourneyTransitionInput`, `JourneyTransitionResult`, `JourneyHealthInput`, `JourneyHealthResult`, `HealthSignal`
- `packages/shared/src/state-machines/programme-step.ts` -- `StepTransitionInput`, `StepTransitionResult`, `StepStartPreconditionInput`, `StepStartPreconditionResult`, `StepReviewPreconditionInput`, `StepReviewPreconditionResult`, `NextBestActionsInput`
- `packages/shared/src/state-machines/risk-acceptance.ts` -- `RiskAcceptanceTransitionResult`, `ResolvedAcceptanceAuthority`
- `packages/shared/src/state-machines/risk-status.ts` -- `RISK_TRANSITIONS_REQUIRING_REASON`, `RiskStatusTransitionInput`, `RiskStatusTransitionResult`
...
- `packages/shared/src/url-safety.ts` -- `webhookUrlRefine`, `webhookUrlRefineMessage`
- `packages/shared/src/utils/fair-monte-carlo.ts` -- `LossComponent`, `HistogramBucket`, `ExceedancePoint`, `SensitivityEntry`, `SimulationResult`
- `packages/shared/src/utils/language-resolver.ts` -- `SupportedLanguage`, `TranslatableField`, `ResolveOptions`, `ResolvedEntityMeta`, `TRANSLATION_SOURCE_COLUMNS`, `TRANSLATION_ENTITIES_WITHOUT_SOFT_DELETE`
- `packages/shared/src/utils/xliff.ts` -- `XliffImportResult`
