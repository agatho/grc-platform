...
| `packages/shared/src/types/eam-advanced.ts`              | 29     | `TransferMechanism`, `EncryptionType`, `EncryptionAtRest`, `DataFlowFrequency`, `DataFlowStatus`, `LegalBasis`, `SchremsIiSafeguard`, `InterfaceType`, `InterfaceDirection`, `HealthStatus` ...                                                                                                                                         |
