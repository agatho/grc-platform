...
| G-09 | Workflow-Engine: Aufgaben, Eskalation, Email | MUSS | ✓ | Task-Entity + Email in Sprint 1.2; **BIC zeigt: Übergangs-Buttons direkt in Work-Item-Detail (← Prev Status, Next Status →)** → S1.4 WorkItemDetailLayout. |
...
BIC Information Security ist das am detailliertesten dokumentierte Modul (25 von 46 Screenshots). Es offenbart eine komplexere Architektur als in der bisherigen Gap-Analyse abgebildet.

## 4.1 Ursprüngliche Anforderungen (I-01 bis I-12)

| ID | Anforderung (Kurzform) | Prio | Abdeckung Vorbilder | Hinweise |
|----|------------------------|------|---------------------|----------|
| I-01 | ISO 27001:2022 + Anhang-A | MUSS | ✓✓ GBTEC, intuitem | BIC: Vollständige ISO/IEC 27002:2022 Kontroll-Liste (5.1–8.34) in Asset Controls-Tab sichtbar. |
| I-02 | NIS2-Mapping | MUSS | ✓✓ | Standard Framework-Import. |
| I-03 | BSI IT-Grundschutz | SOLLTE | ✓ | BIC: Gefährdungskatalog (G.0.x) als Risk-Catalog-Seed sichtbar (G.0.1 Fire, G.0.10–G.0.15). |
| I-04 | Asset-Verwaltung | MUSS | ✓✓ GBTEC | **Massiv erweitert** durch BIC-Analyse → G-NEW-01 bis G-NEW-07. |
| I-05 | Risikobewertung | MUSS | ✓✓ | Assessment-Wizard (BIC) zeigt detaillierteren Prozess → I-NEW-03. |
| I-06 | SoA-Management + Anhang-A | MUSS | ✓✓ | BIC: Maturity-Bewertung auf Controls → I-NEW-05. |
| I-07 | Security-Incident-Management | MUSS | ✓✓ | **Massiv erweitert** durch Incident-Screenshots → I-NEW-10 bis I-NEW-18. |
| I-08 | Schwachstellen-/Patch-Tracking | SOLL | ✓ | BIC: Vulnerability als eigener Work-Item-Typ mit Status-Workflow. |
...
## 4.2 Neue ISMS-Anforderungen aus BIC-Analyse
...
## 5.1 Neue BCMS-Anforderungen aus BIC-Analyse
...
BIC zeigt Single Risk Dashboard mit qualitativ (47) + quantitativ (10+3) Bewertungen und 5 Risikostufen (0-7, 8-14, 15-22, 23-29, 30-36). Kein wesentlicher neuer Gap zur bestehenden Sprint-2-Planung.
...
BIC zeigt einen eigenständigen "Perform Assessment"-Workflow als separaten Bereich (nicht integriert in Asset-Management):
...
Sprint 1.4     → Extended Assets + Work Item System + Tab-Nav          ⬜ NEU (aus BIC-Analyse)
