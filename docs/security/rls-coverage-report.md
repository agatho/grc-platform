...
Erzeugt mit `node scripts/audit-rls-coverage.mjs` gegen `postgresql://grc:***@localhost:5432/wp2_verify`.
...
| `organization` | PLATFORM | ✅ | ✅ | 2 | ✅ | PLATFORM_EXEMPT |
...
| `whistleblowing_audit_log` | PLATFORM | ✅ | ✅ | 2 | ❌ | PLATFORM_EXEMPT |
