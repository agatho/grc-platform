...
export const processReplicationMonitor = withCronInstrumentation(
  "replication-monitor",
  async (): Promise<ReplicationMonitorResult> => {
    const result: ReplicationMonitorResult = {
      checked: 0,
      alerts: 0,
      errors: 0,
    };
