...
const CIA_LEVELS = [
  { value: 1, key: "low", bg: "bg-green-500", hover: "hover:bg-green-600", ring: "ring-green-300" },
  { value: 2, key: "medium", bg: "bg-yellow-500", hover: "hover:bg-yellow-600", ring: "ring-yellow-300" },
  { value: 3, key: "high", bg: "bg-orange-500", hover: "hover:bg-orange-600", ring: "ring-orange-300" },
  { value: 4, key: "veryHigh", bg: "bg-red-500", hover: "hover:bg-red-600", ring: "ring-red-300" },
] as const;
...
export function CiaColorBar({ label, value, onChange, readOnly = false }: CiaColorBarProps) {
...
export function protectionGoalClassColor(pgc: number | null | undefined): string {
...
export function protectionGoalClassLabel(pgc: number | null | undefined, t: (key: string) => string): string {
