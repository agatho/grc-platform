...
// [ARCTOS-FULL-2026-08-31 · OP-070] Der Schliessen-Knopf traegt nur ein Kreuz;
// sein zugaenglicher Name stand fest auf „Close". Fuer einen Nutzer mit
// Screenreader ist das die einzige Beschriftung, die er hier ueberhaupt hoert.
