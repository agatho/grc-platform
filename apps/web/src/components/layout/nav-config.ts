...
export const NAV_GROUPS: NavGroup[] = [
  ...
  // ── ISMS — Information Security (+ NIS2, DORA, AI Act) ──
  {
    ...
    items: [
      ...
      { labelKey: "nav.grouped.ismsCapMonitor", href: "/isms/cap-monitor", icon: Clock, roles: ["admin", "risk_manager", "auditor"], moduleKey: "isms", parentModule: "isms" },
      ...
      { labelKey: "nav.grouped.aiActAnnualReport", href: "/ai-act/annual-report", icon: FileText, roles: ["admin", "risk_manager", "auditor"], moduleKey: "isms", parentModule: "isms-regulatory" },
      { labelKey: "nav.grouped.aiActIncidentsMonitor", href: "/ai-act/incidents/monitor", icon: Clock, roles: ["admin", "risk_manager"], moduleKey: "isms", parentModule: "isms-regulatory" },
  ...
  // ── BCMS — Business Continuity ──
  {
    ...
    items: [
      ...
      { labelKey: "nav.grouped.bcmsReadiness", href: "/bcms/readiness-monitor", icon: Clock, roles: ["admin", "risk_manager"], moduleKey: "bcms", parentModule: "bcms" },
  ...
  // ── DPMS — Data Protection ──
  {
    ...
    items: [
      ...
      { labelKey: "nav.grouped.dpmsDeadlineMonitor", href: "/dpms/deadline-monitor", icon: Clock, roles: ["admin", "dpo"], moduleKey: "dpms", parentModule: "dpms" },
