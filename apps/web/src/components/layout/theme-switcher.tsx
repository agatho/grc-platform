...
export function ThemeSwitcher() {
  ...
  return (
    <div className="px-1 py-1">
      <p className="px-2 py-1 text-[11px] font-medium uppercase tracking-wider text-gray-400">Theme</p>
      {themes.map((t) => {
        const Icon = t.icon;
      ...
      <p className="px-2 py-1 text-[11px] font-medium uppercase tracking-wider text-gray-400">Layout</p>
