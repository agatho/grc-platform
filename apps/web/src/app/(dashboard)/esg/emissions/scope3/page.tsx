...
const SCOPE3_CATEGORIES = [
  {
    ...
    key: "purchased_goods",
    icon: ShoppingBag,
    label: "Eingekaufte Güter und Dienstleistungen",
    labelEn: "Purchased Goods & Services",
    upstream: true,
  },
  {
    num: 2,
  ...
  },
  {
    ...
    key: "fuel_energy",
    icon: Fuel,
    label: "Brennstoff- und energiebezogene Emissionen",
    labelEn: "Fuel & Energy Activities",
    upstream: true,
  },
  {
    num: 4,
    ...
    icon: Truck,
    label: "Vorgelagerter Transport und Distribution",
    labelEn: "Upstream Transport & Distribution",
    upstream: true,
  },
  {
    num: 5,
    key: "waste",
    icon: Recycle,
    label: "Abfallentsorgung im Betrieb",
  ...
  },
  {
    ...
    key: "commuting",
    icon: Users,
    label: "Pendlerverkehr der Mitarbeiter",
  ...
  },
  {
    ...
    key: "upstream_leased",
    icon: Building2,
    label: "Vorgelagerte geleaste Vermögenswerte",
  ...
  },
  {
    ...
    icon: Truck,
    label: "Nachgelagerter Transport und Distribution",
    labelEn: "Downstream Transport & Distribution",
    upstream: false,
  },
  {
    num: 10,
    key: "processing",
    icon: Factory,
    label: "Verarbeitung verkaufter Produkte",
  ...
  },
  {
    ...
    key: "use_of_products",
    icon: Zap,
    label: "Nutzung verkaufter Produkte",
  ...
  },
  {
    ...
    key: "end_of_life",
    icon: Recycle,
    label: "End-of-Life-Behandlung verkaufter Produkte",
    labelEn: "End-of-Life Treatment",
    upstream: false,
  },
  {
    num: 13,
    key: "downstream_leased",
    icon: Building2,
    label: "Nachgelagerte geleaste Vermögenswerte",
...
export default function Scope3CategoriesPage() {
  const [filter, setFilter] = useState<"all" | "upstream" | "downstream">(
    "all",
  );
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">
            Scope 3 — Alle 15 Kategorien
          </h1>
          <p className="text-sm text-gray-500 mt-1">
            GHG Protocol Scope 3: Vorgelagerte und nachgelagerte
            Wertschöpfungskette
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        {[
          ...
          { key: "upstream" as const, label: `Vorgelagert (${upstreamCount})` },
          {
            ...
            label: `Nachgelagert (${downstreamCount})`,
          },
        ].map((f) => (
          <button
            key={f.key}
