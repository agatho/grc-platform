  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="rounded-lg border border-gray-200 bg-white p-6">
          ...
          <dl className="space-y-3 text-sm">
            <div className="flex justify-between">
              ...
              <dd className="font-medium">{config.requireMfa ? t("yes") : t("no")}</dd>
            </div>
            <div className="flex justify-between">
              <dt className="text-gray-500">{t("sessionTimeout")}</dt>
              <dd className="font-medium">{config.sessionTimeoutMinutes} min</dd>
            </div>
            <div className="flex justify-between">
        ...
        {config.description && (
          <div className="rounded-lg border border-gray-200 bg-white p-6">
            <h2 className="text-base font-semibold mb-4">{t("detailDescription")}</h2>
