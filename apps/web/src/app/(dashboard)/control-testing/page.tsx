      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold">{data.activeScripts}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4">
        ...
        <Card>
          <CardContent className="p-4">
            <p className="text-sm text-muted-foreground">{t("failRate")}</p>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold">{data.learningPatterns}</p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent>
          <div className="space-y-2">
            {data.recentExecutions.map((exec) => (
              <Link
                key={exec.id}
                href={`/control-testing/executions?id=${exec.id}`}
                className="block"
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-sm">
                        {t("execution")} {exec.id.substring(0, 8)}
                      </p>
