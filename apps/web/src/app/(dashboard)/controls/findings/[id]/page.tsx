                ...
                >
                  ...
                  <div className="flex-1">
                    <p className="text-sm">
                      ...
                      <Badge
                        variant="outline"
                        className={statusBadgeClass(entry.fromStatus)}
                      >
