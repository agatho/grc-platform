...
// placeholder so users know BPM maturity assessment is on the roadmap.
  ...
  return (
    <ModuleGate moduleKey="bpm">
      ...
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold">Prozess-Reifegrad</h1>
          <p className="text-sm text-gray-500 mt-1">
            CMMI / BPMM Maturity Assessment auf Prozess-Ebene
          </p>
        </div>
        <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-200 bg-gray-50 py-16 text-center">
          ...
          <p className="text-sm text-gray-500 mt-2 max-w-md">
            CMMI-Level-Bewertung pro Prozess (Initial → Optimizing). Bis dahin
            nutzen Sie die generische Reifegrad-Bewertung im Audit-Modul.
          </p>
        </div>
      </div>
    </ModuleGate>
