...
function ResilienceDashboardInner() {
  ...
  const factors = score
    ? [
        {
          label: t("biaCompleteness"),
          value: score.biaCompleteness,
          weight: 20,
        },
        { label: t("bcpCurrency"), value: score.bcpCurrency, weight: 15 },
        {
          label: t("exerciseCompletion"),
          value: score.exerciseCompletion,
          weight: 15,
        },
        {
          label: t("recoverCapability"),
          value: score.recoverCapability,
          weight: 20,
        },
        {
          label: t("communicationReadiness"),
          value: score.communicationReadiness,
          weight: 10,
        },
        {
          label: t("procedureCompleteness"),
          value: score.procedureCompleteness,
          weight: 10,
        },
        {
          label: t("supplyChainResilience"),
          value: score.supplyChainResilience,
          weight: 10,
        },
      ]
    : [];
      ...
      <Card>
        ...
        <CardContent className="flex items-center justify-center">
          <div className="text-center">
            <div
              className={`text-6xl font-bold ${scoreColor(score?.overallScore ?? 0)}`}
            >
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {factors.map((f) => (
          <Card key={f.label}>
            ...
            <CardContent>
              <div className={`text-2xl font-bold ${scoreColor(f.value)}`}>
                {f.value}
              </div>
