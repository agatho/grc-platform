                  ...
                  {(d?.topRoi ?? []).slice(0, 10).map((item, idx) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-2 text-right">
                        <span
                          className={`font-bold ${item.roiPercent >= 100 ? "text-green-700" : item.roiPercent >= 0 ? "text-yellow-700" : "text-red-700"}`}
                        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="rounded-lg border border-green-100 bg-green-50 p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-sm font-medium text-gray-700">
                {t("roi.penaltyAvoidance")}
              </h3>
            </div>
            <p className="text-xs text-gray-500 mb-3">
              {t("roi.penaltyDescription")}
            </p>
            <div className="space-y-2">
              <div className="flex justify-between">
                <span className="text-xs text-gray-600">
                  {t("roi.potentialFines")}
                </span>
          ...
          <div className="rounded-lg border border-blue-100 bg-blue-50 p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="text-sm font-medium text-gray-700">
                {t("roi.incidentAvoidance")}
              </h3>
            </div>
            <p className="text-xs text-gray-500 mb-3">
              {t("roi.incidentDescription")}
            </p>
            <div className="space-y-2">
              <div className="flex justify-between">
                <span className="text-xs text-gray-600">
              ...
              <div className="flex justify-between">
                <span className="text-xs text-gray-600">
                  {t("roi.preventedIncidents")}
                </span>
                <span className="text-sm font-medium text-gray-700">
                  {d?.incidentAvoidance?.prevented ?? 0}
                </span>
              </div>
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6">
          ...
          <p className="text-xs text-gray-500 mb-4">
            {t("roi.roiVsRoniDescription")}
          </p>
          <div className="space-y-3">
            {(d?.roiVsRoni ?? []).slice(0, 10).map((item) => {
              const maxVal = Math.max(
                item.investmentCost,
                perspective === "cfo" ? item.roniCfo : item.roniCiso,
                1,
              );
              return (
                <div
                ...
                >
                  ...
                  <div className="flex-1 flex gap-1">
                    <div
                      ...
                      style={{
                        width: `${(item.investmentCost / maxVal) * 50}%`,
                        minWidth: "20px",
                      }}
                    >
                    ...
                    <div
                      ...
                      style={{
                        width: `${((perspective === "cfo" ? item.roniCfo : item.roniCiso) / maxVal) * 50}%`,
                        minWidth: "20px",
                      }}
                    >
                      {(perspective === "cfo" ? item.roniCfo : item.roniCiso) >
