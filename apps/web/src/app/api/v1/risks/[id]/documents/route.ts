...
// #NIGHT-035: resource-nested document list. Replaces the old
// pattern where the UI either pulled the global /documents list and
// filtered client-side, or hit a 404 trying /risks/{id}/documents.
    ...
    const rows = await db
      ...
      .where(
        and(
          ...
          eq(documentEntityLink.entityType, "risk"),
