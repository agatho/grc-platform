...
export async function POST(req: Request) {
  ...
  const generatedScript = {
    ...
    description: "Automatically generated test script based on control requirements.",
    ...
    steps: [
      { order: 1, instruction: "Verify control is active and configured", expectedResult: "Control is enabled", isAutomated: true },
      { order: 2, instruction: "Check evidence is current (< 90 days)", expectedResult: "Evidence is fresh", isAutomated: true },
      { order: 3, instruction: "Validate control effectiveness score", expectedResult: "Score >= 70%", isAutomated: false },
    ],
  };
