...
export const updateRetentionScheduleSchema =
  createRetentionScheduleSchema.partial();
...
export const updateTiaAdvancedSchema = createTiaAdvancedSchema
  .partial()
  .extend({
...
export const DPIA_TRIGGER_CRITERIA = [
  {
    ...
    description:
      "Systematic and extensive monitoring of a publicly accessible area",
  },
  {
    id: "sensitive_data",
    description:
      "Processing of special categories of data or criminal offence data on a large scale",
  },
  {
    id: "large_scale",
    description: "Processing of personal data on a large scale",
  },
  {
    id: "vulnerable_subjects",
    description:
      "Processing of data concerning vulnerable data subjects (children, employees, patients)",
  },
  {
    id: "innovative_technology",
    description: "Use of innovative technological or organizational solutions",
  },
  {
  ...
  },
  {
    ...
    description: "Matching or combining datasets from different sources",
  },
  {
    id: "profiling",
    description: "Evaluation or scoring of data subjects (profiling)",
  },
  {
...
export function assessDpiaTrigger(
  criteriaMet: Array<{ criterion: string; met: boolean }>,
): {
...
export const ART_28_CHECKLIST_ITEMS = [
  {
    requirement: "Subject matter and duration of processing defined",
    article: "Art. 28(3)",
    category: "scope",
  },
  {
    requirement: "Nature and purpose of processing specified",
    article: "Art. 28(3)",
    category: "scope",
  },
  {
    requirement: "Types of personal data specified",
    article: "Art. 28(3)",
    category: "scope",
  },
  {
    requirement: "Categories of data subjects specified",
    article: "Art. 28(3)",
    category: "scope",
  },
  {
    requirement: "Obligations and rights of the controller defined",
    article: "Art. 28(3)",
    category: "obligations",
  },
  {
    requirement: "Processing only on documented instructions",
    article: "Art. 28(3a)",
    category: "instructions",
  },
  {
    requirement: "Confidentiality obligation for processing staff",
    article: "Art. 28(3b)",
    category: "confidentiality",
  },
  {
    requirement: "Appropriate technical and organizational measures",
    article: "Art. 28(3c)/Art. 32",
    category: "security",
  },
  {
    requirement: "Sub-processor engagement conditions defined",
    article: "Art. 28(3d)",
    category: "sub_processors",
  },
  {
    requirement: "Prior written authorization for sub-processors",
    article: "Art. 28(2)",
    category: "sub_processors",
  },
  {
  ...
  {
    requirement: "Assistance with security obligations (Art. 32-36)",
    article: "Art. 28(3f)",
    category: "security",
  },
  {
    requirement: "Deletion or return of data after end of services",
    article: "Art. 28(3g)",
    category: "termination",
  },
  {
    requirement: "Audit and inspection rights granted",
    article: "Art. 28(3h)",
    category: "audit",
  },
  {
    requirement: "Information obligation regarding instruction conflicts",
    article: "Art. 28(3) last para",
    category: "instructions",
  },
  {
    requirement: "International transfer safeguards (if applicable)",
    article: "Art. 28(3)/Art. 44-49",
    category: "transfers",
  },
];

// ─── Consent Pseudonymization ───────────────────────────────
export function hashDataSubjectIdentifier(
  identifier: string,
  orgSalt: string,
): string {
...
export function computePbdScore(
  ...
  const overallScore =
    principleScores.length > 0
      ? Math.round(
          principleScores.reduce((a, b) => a + b.score, 0) /
            principleScores.length,
        )
      : 0;
