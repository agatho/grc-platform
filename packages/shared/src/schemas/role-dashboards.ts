...
export const updateRoleDashboardConfigSchema = createRoleDashboardConfigSchema
  .partial()
  .omit({ dashboardType: true });
...
export type CreateRoleDashboardConfigInput = z.infer<
  typeof createRoleDashboardConfigSchema
>;
export type UpdateRoleDashboardConfigInput = z.infer<
  typeof updateRoleDashboardConfigSchema
>;
export type UpsertWidgetPreferenceInput = z.infer<
  typeof upsertWidgetPreferenceSchema
>;
export type BulkUpsertWidgetPreferencesInput = z.infer<
  typeof bulkUpsertWidgetPreferencesSchema
>;
