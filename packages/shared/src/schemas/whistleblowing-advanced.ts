...
export function isValidInvestigationTransition(
  current: string,
  next: string,
): boolean {
...
export const DEFAULT_RETALIATION_RULES = [
  {
    ...
    timeWindowMonths: 6,
    severity: "suspicious",
    description: "Negative performance review within 6 months of report",
  },
  {
    eventType: "termination",
    timeWindowMonths: 0,
    severity: "critical",
    description: "Termination at any time after report",
  },
  {
    eventType: "role_change",
    timeWindowMonths: 3,
    severity: "suspicious",
    description: "Role change within 3 months of report",
  },
  {
    eventType: "salary_change",
    timeWindowMonths: 6,
    severity: "suspicious",
    description: "Salary reduction within 6 months of report",
  },
  {
    eventType: "assignment_change",
    timeWindowMonths: 3,
    severity: "suspicious",
    description: "Assignment change within 3 months of report",
  },
] as const;
