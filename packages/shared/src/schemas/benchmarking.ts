...
export const updateMaturityModelSchema = createMaturityModelSchema
  .partial()
  .omit({ moduleKey: true });
...
export const updateMaturityRoadmapItemSchema = createMaturityRoadmapItemSchema
  .partial()
  .extend({
...
export const submitBenchmarkSchema = z.object({
  ...
  consentGiven: z
    .boolean()
    .refine((val) => val === true, { message: "Consent must be given" }),
});
...
export type CreateMaturityModelInput = z.infer<
  typeof createMaturityModelSchema
>;
export type UpdateMaturityModelInput = z.infer<
  typeof updateMaturityModelSchema
>;
export type CreateMaturityAssessmentInput = z.infer<
  typeof createMaturityAssessmentSchema
>;
export type UpdateMaturityAssessmentInput = z.infer<
  typeof updateMaturityAssessmentSchema
>;
export type CreateMaturityRoadmapItemInput = z.infer<
  typeof createMaturityRoadmapItemSchema
>;
