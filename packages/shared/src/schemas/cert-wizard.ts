...
const readinessStatusEnum = z.enum(["draft", "in_progress", "completed", "approved", "expired"]);
const evidenceStatusEnum = z.enum(["draft", "generating", "complete", "submitted"]);
const mockAuditTypeEnum = z.enum(["stage_1", "stage_2", "surveillance", "recertification"]);
const mockAuditStatusEnum = z.enum(["draft", "in_progress", "completed", "reviewed"]);
