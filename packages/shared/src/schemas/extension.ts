...
export const createPluginSchema = z.object({
  ...
  category: z.enum(["general", "compliance", "risk", "reporting", "integration", "automation", "security", "analytics"]).default("general"),
...
export const updatePluginSchema = createPluginSchema.partial().omit({ key: true });

// Plugin Installation
export const installPluginSchema = z.object({
  pluginId: z.string().uuid(),
  config: z.record(z.unknown()).default({}),
  hookBindings: z.array(z.object({
...
export const updateMarketplaceListingSchema = createMarketplaceListingSchema.partial().omit({ pluginId: true });
...
export type UpdatePluginInstallationInput = z.infer<typeof updatePluginInstallationSchema>;
export type UpdatePluginSettingInput = z.infer<typeof updatePluginSettingSchema>;
