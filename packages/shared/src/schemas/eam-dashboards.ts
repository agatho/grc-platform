...
export const functionalFitEnum = z.enum([
  "perfect",
  "appropriate",
  "insufficient",
]);
export const technicalFitEnum = z.enum([
  "perfect",
  "appropriate",
  "insufficient",
]);
export const sixRStrategyEnum = z.enum([
  "retain",
  "replatform",
  "refactor",
  "rearchitect",
...
export const businessCriticalityEnum = z.enum([
  "mission_critical",
  "business_critical",
...
export const strategicAlignmentEnum = z.enum([
  "aligned",
  "partially",
  "misaligned",
]);
export const capabilityLifecycleStatusEnum = z.enum([
  "active",
  "transforming",
  "retiring",
  "planned",
