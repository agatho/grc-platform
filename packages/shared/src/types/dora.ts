...
export type DoraIctAssetType = "network" | "hardware" | "software" | "data" | "cloud_service" | "third_party";
export type DoraThreatCategory = "cyber_attack" | "system_failure" | "human_error" | "natural_disaster" | "third_party_failure";
export type DoraLikelihood = "very_low" | "low" | "medium" | "high" | "very_high";
export type DoraImpact = "very_low" | "low" | "medium" | "high" | "very_high";
export type DoraRiskLevel = "low" | "medium" | "high" | "critical";
export type DoraTreatmentStrategy = "mitigate" | "accept" | "transfer" | "avoid";
export type DoraIctRiskStatus = "identified" | "assessed" | "treated" | "accepted" | "closed";
export type DoraTlptTestType = "red_team" | "purple_team" | "scenario_based" | "full_tlpt";
export type DoraTlptStatus = "draft" | "planned" | "in_progress" | "completed" | "remediation";
export type DoraIncidentType = "cyber_attack" | "system_outage" | "data_breach" | "third_party_failure" | "operational_disruption";
export type DoraIncidentClassification = "major" | "significant" | "minor";
export type DoraIncidentStatus = "detected" | "investigating" | "contained" | "resolved" | "closed";
export type DoraProviderServiceType = "cloud" | "software" | "infrastructure" | "network" | "data_processing" | "consulting";
export type DoraProviderCriticality = "critical" | "important" | "standard";
export type DoraComplianceStatus = "compliant" | "partially_compliant" | "non_compliant" | "pending" | "not_assessed";
export type DoraProviderStatus = "active" | "under_review" | "terminated" | "pending";
export type DoraSharingType = "threat_intelligence" | "vulnerability" | "incident_info" | "best_practice";
export type DoraTlpClassification = "tlp_white" | "tlp_green" | "tlp_amber" | "tlp_red";
export type DoraSharingStatus = "draft" | "approved" | "shared" | "revoked";
export type DoraOverlapType = "full_overlap" | "partial_overlap" | "dora_only" | "nis2_only";
