...
| `repo-arctos-foreign-extension-and-existing-grcmetadata` | `…bpmn-arctos-parse.test.ts:25`                                     |     9 | **der Vertragsfall aus §5.3:** `<foo:props value="keep-me"/>` muss überleben, vorhandenes `arctos:grcMetadata` muss _ersetzt statt dupliziert_ werden |
