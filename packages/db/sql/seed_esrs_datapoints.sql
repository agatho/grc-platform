...
VALUES
  (gen_random_uuid(), 'E1', 'E1-1', 'E1-1.p16a',
   ...
   'Offenlegung des Transitionsplans des Unternehmens zur Klimaschutzminderung, einschließlich zentraler Annahmen und Ausrichtung auf die Begrenzung der globalen Erwärmung auf 1,5 Grad Celsius.',
  ...
  (gen_random_uuid(), 'E1', 'E1-1', 'E1-1.p16b',
   ...
   'Ob der Transitionsplan mit der Begrenzung der globalen Erwärmung auf 1,5 Grad Celsius im Einklang mit dem Pariser Abkommen vereinbar ist.',
  ...
  (gen_random_uuid(), 'E1', 'E1-1', 'E1-1.p16d',
   ...
   'Wichtige Dekarbonisierungshebel und geplante Maßnahmen',
   ...
   'Beschreibung der identifizierten zentralen Dekarbonisierungshebel und geplanten Maßnahmen, einschließlich Änderungen im Produktportfolio und Einführung neuer Technologien.',
  ...
  (gen_random_uuid(), 'E1', 'E1-1', 'E1-1.p16e',
   ...
   'Gebundene THG-Emissionen aus wichtigen Vermögenswerten',
   'Disclosure of significant locked-in GHG emissions from the undertaking''s key assets and products.',
   'Offenlegung signifikanter gebundener THG-Emissionen aus wichtigen Vermögenswerten und Produkten des Unternehmens.',
  ...
  (gen_random_uuid(), 'E1', 'E1-1', 'E1-1.p16f',
   ...
   'Offenlegung der für die Umsetzung des Transitionsplans erforderlichen CapEx- und OpEx-Beträge oder -Prozentsätze.',
  ...
  (gen_random_uuid(), 'E1', 'E1-3', 'E1-3.p26',
   ...
   'Maßnahmen und Ressourcen im Zusammenhang mit dem Klimawandel',
   'Description of the key actions taken and planned to achieve climate-related targets and manage risks and opportunities.',
   'Beschreibung der wichtigsten ergriffenen und geplanten Maßnahmen zur Erreichung klimabezogener Ziele und zum Management von Risiken und Chancen.',
  ...
  (gen_random_uuid(), 'E1', 'E1-4', 'E1-4.p34',
   ...
   'Offenlegung der vom Unternehmen festgelegten THG-Emissionsreduktionsziele, einschließlich ob sie wissenschaftsbasiert und durch SBTi validiert sind.',
  ...
  (gen_random_uuid(), 'E1', 'E1-4', 'E1-4.p34a',
   ...
   'Offenlegung des absoluten Werts des THG-Emissionsreduktionsziels für Scope 1, 2 und 3.',
  ...
  (gen_random_uuid(), 'E1', 'E1-4', 'E1-4.p34b',
   ...
   'Zieljahr für THG-Emissionsreduktion',
...
VALUES
  ...
  (gen_random_uuid(), 'E2', 'E2-4', 'E2-4.p26',
   ...
   'Mengen jedes in die Luft emittierten Schadstoffs, die in Anhang II der E-PRTR-Verordnung aufgeführt sind.',
...
VALUES
  (gen_random_uuid(), 'E4', 'E4-1', 'E4-1.p10',
   ...
   'Transitionsplan für Biodiversität und Ökosysteme',
   ...
   'Offenlegung des Transitionsplans zur Verbesserung des Schutzes von Biodiversität und Ökosystemen, einschließlich wissenschaftsbasierter Ziele.',
   'narrative', NULL, false, 'annual', NULL, ARRAY['biodiversity', 'transition_plan']
  ),
  (gen_random_uuid(), 'E4', 'E4-2', 'E4-2.p18',
   'Policies related to biodiversity and ecosystems',
   'Strategien in Bezug auf Biodiversität und Ökosysteme',
   'Disclosure of policies to manage material impacts, risks and opportunities related to biodiversity and ecosystems.',
   'Offenlegung der Strategien zur Steuerung wesentlicher Auswirkungen, Risiken und Chancen in Bezug auf Biodiversität und Ökosysteme.',
  ...
  (gen_random_uuid(), 'E4', 'E4-5', 'E4-5.p33',
   ...
   'Wirkungskennzahlen zum Biodiversitätswandel',
   ...
   'Offenlegung von Kennzahlen zu den Auswirkungen des Unternehmens auf die Biodiversität, einschließlich Landnutzungsänderungen und Ökosystemdegradation.',
...
VALUES
  ...
  (gen_random_uuid(), 'E5', 'E5-5', 'E5-5.p40',
   ...
   'Ressourcenzuflüsse einschließlich Recyclinganteil',
...
VALUES
  (gen_random_uuid(), 'S1', 'S1-1', 'S1-1.p20',
   ...
   'Offenlegung der Strategien zur Steuerung wesentlicher Auswirkungen auf die eigene Belegschaft, einschließlich Menschenrechtsverpflichtungen.',
  ...
  (gen_random_uuid(), 'S1', 'S1-3', 'S1-3.p30',
   ...
   'Abhilfeprozesse für negative Auswirkungen auf die eigene Belegschaft',
  ...
  (gen_random_uuid(), 'S1', 'S1-8', 'S1-8.p61',
   ...
   'Prozentsatz der Beschäftigten, die durch Tarifvertraege abgedeckt sind.',
  ...
  (gen_random_uuid(), 'S1', 'S1-9', 'S1-9.p66',
   ...
   'Verteilung der Beschäftigten nach Geschlecht, einschließlich Management und anderen Ebenen.',
  ...
  (gen_random_uuid(), 'S1', 'S1-10', 'S1-10.p71',
   ...
   'Ob alle Beschäftigten einen angemessenen Lohn erhalten, bewertet anhand geltender Benchmarks.',
...
VALUES
  (gen_random_uuid(), 'S2', 'S2-1', 'S2-1.p14',
   ...
   'Strategien in Bezug auf Arbeitnehmer in der Wertschöpfungskette',
   'Disclosure of policies to manage material impacts on workers in the value chain, including forced labour and child labour.',
   'Offenlegung der Strategien zur Steuerung wesentlicher Auswirkungen auf Arbeitnehmer in der Wertschöpfungskette, einschließlich Zwangsarbeit und Kinderarbeit.',
  ...
  (gen_random_uuid(), 'S2', 'S2-2', 'S2-2.p19',
   ...
   'Prozesse zur Einbindung der Arbeitnehmer in der Wertschöpfungskette',
   'Description of general processes for engaging with value chain workers about actual and potential impacts.',
   'Beschreibung der allgemeinen Prozesse zur Einbindung der Arbeitnehmer in der Wertschöpfungskette in Bezug auf tatsaechliche und potenzielle Auswirkungen.',
  ...
  (gen_random_uuid(), 'S2', 'S2-5', 'S2-5.p37',
   ...
   'Beschreibung wesentlicher negativer und positiver Auswirkungen auf Arbeitnehmer in der Wertschöpfungskette im Zusammenhang mit den Geschaeftstaetigkeiten des Unternehmens.',
...
VALUES
  (gen_random_uuid(), 'S3', 'S3-1', 'S3-1.p13',
   ...
   'Offenlegung der Strategien zur Steuerung wesentlicher Auswirkungen, Risiken und Chancen in Bezug auf betroffene Gemeinschaften, einschließlich indigener Völker.',
  ...
  (gen_random_uuid(), 'S3', 'S3-4', 'S3-4.p36',
   ...
   'Beschreibung wesentlicher negativer und positiver Auswirkungen auf betroffene Gemeinschaften im Zusammenhang mit Geschaeftstaetigkeiten und Wertschöpfungskette des Unternehmens.',
...
VALUES
  (gen_random_uuid(), 'S4', 'S4-1', 'S4-1.p13',
   ...
   'Offenlegung der Strategien zur Steuerung wesentlicher Auswirkungen, Risiken und Chancen in Bezug auf Verbraucher und Endnutzer, einschließlich Produktsicherheit und Datenschutz.',
...
VALUES
  ...
  (gen_random_uuid(), 'G1', 'G1-1', 'G1-1.p10a',
   ...
   'Beschreibung der Richtlinien zur Bekämpfung von Korruption und Bestechung, einschließlich Schulungs- und Sensibilisierungsprogrammen.',
  ...
  (gen_random_uuid(), 'G1', 'G1-2', 'G1-2.p15',
   ...
   'Informationen über das Management der Beziehungen zu Lieferanten, einschließlich Zahlungspraktiken.',
  ...
  (gen_random_uuid(), 'G1', 'G1-5', 'G1-5.p27',
   ...
   'Beschreibung der Aktivitäten und Verpflichtungen im Zusammenhang mit politischer Einflussnahme, einschließlich Lobbying.',
