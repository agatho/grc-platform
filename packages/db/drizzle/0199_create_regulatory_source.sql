...
CREATE INDEX regulatory_source_org_idx ON regulatory_source(org_id);
CREATE INDEX regulatory_source_jurisdiction_idx ON regulatory_source(jurisdiction);
CREATE INDEX regulatory_source_active_idx ON regulatory_source(is_active);
