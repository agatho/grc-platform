...
CREATE INDEX control_test_script_org_idx ON control_test_script(org_id);
CREATE INDEX control_test_script_control_idx ON control_test_script(org_id, control_id);
CREATE INDEX control_test_script_type_idx ON control_test_script(org_id, test_type);
CREATE INDEX control_test_script_active_idx ON control_test_script(org_id, is_active);
