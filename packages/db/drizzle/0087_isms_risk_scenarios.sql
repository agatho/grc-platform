...
-- Änderung: Demo-Seed auf Phantom-Org c2446a5c auf No-Op-Guard umgestellt (S09-07).
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM organization WHERE id = 'c2446a5c-64f1-40a7-862a-8ab084f66f41') THEN
    RAISE NOTICE '0087: Demo-Org c2446a5c nicht vorhanden - Risikoszenarien uebersprungen';
    RETURN;
  END IF;
