...
CREATE INDEX cte_script_idx ON control_test_execution(script_id);
CREATE INDEX cte_org_idx ON control_test_execution(org_id);
CREATE INDEX cte_control_idx ON control_test_execution(org_id, control_id);
CREATE INDEX cte_status_idx ON control_test_execution(org_id, status);
CREATE INDEX cte_date_idx ON control_test_execution(org_id, created_at);
