...
CREATE INDEX ac_org_idx ON academy_course(org_id);
CREATE INDEX ac_type_idx ON academy_course(org_id, course_type);
CREATE INDEX ac_mandatory_idx ON academy_course(org_id, is_mandatory);
