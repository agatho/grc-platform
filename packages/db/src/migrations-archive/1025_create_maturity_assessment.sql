...
CREATE INDEX ma_org_idx ON maturity_assessment(org_id);
CREATE INDEX ma_module_idx ON maturity_assessment(org_id, module_key);
CREATE INDEX ma_status_idx ON maturity_assessment(org_id, status);
