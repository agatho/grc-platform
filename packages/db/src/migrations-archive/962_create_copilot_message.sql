...
CREATE INDEX cm_conv_idx ON copilot_message(conversation_id);
CREATE INDEX cm_org_idx ON copilot_message(org_id);
CREATE INDEX cm_role_idx ON copilot_message(conversation_id, role);
